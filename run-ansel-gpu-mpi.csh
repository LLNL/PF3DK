...
lrun -N 1 -n 4 --smpiargs="-gpu" nvprof $CODE 128 160   80   10 1 -O3
# lrun -N 1 -n 4 $CODE 128 160   80   10 1 -O3
# lrun -N 1 -n 4 --smpiargs="-gpu" nvprof -o nvprof-rzansel-%q{OMPI_COMM_WORLD_RANK}.prof $CODE 128 160   80   10 1 -O3
