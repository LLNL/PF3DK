...
unsigned long le_generator_omp45[3] = { 0x9ad5e0d7, 0xf08ff6d8, 0xe7ed3a47 };
#ifdef _OPENMP
#pragma omp end declare target
#endif

unsigned long
le_next_omp45(unsigned long *g)
{
  if (!g) g = le_generator_omp45;
  {
...
double
le_random_omp45(unsigned long *g)
{
  /* 1/(2^32-1) */
  return 2.3283064370807974e-10*(le_next_omp45(g)-0.5001);
}

void
le_nrandom_omp45(unsigned long *g, long n, double *r)
{
  if (!g) g = le_generator_omp45;
  {
    unsigned long s1 = g[0];
...
void
le_iseed_omp45(unsigned long *g, unsigned long seed)
{
